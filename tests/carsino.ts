...
const CARSINO_HOURSE_SEED_PREFIX = "carsino_house";
const CARSINO_PLAYER_SEED_PREFIX = "carsino_player";
...
describe("Carsino", () => {
  ...
  it("Build a house",async () => {
    ...
    const [housePda] = await PublicKey.findProgramAddress(
      [
        Buffer.from(CARSINO_HOURSE_SEED_PREFIX),
  ...
  it("Add Player",async () => {
    ...
    const [playerPda] = await PublicKey.findProgramAddress(
      [
        Buffer.from(CARSINO_PLAYER_SEED_PREFIX),
        housePda.toBytes(),
